...
C   END OF ATEMP > 0
C
291   FORMAT(I4,1P,(1E12.4),1P,(4E19.11))
167   FORMAT(I5,1P,(2E19.11),1P,(2E15.7))
C
...
C
      ...
      DO KJ = 1,NEPS
        ...
        IF(DABS(CSN).GT.SML.AND.ICRE.EQ.0) THEN
            ...
            ENDIF
        ENDIF
394   FORMAT(3I5,4E15.7)
448     IF(DABS(SSN).GT.SML.AND.ICIE.EQ.0) THEN
            AHIO = AHIO - OMPG*SSN
            ICI = ICI + 1
            GSP(ICI) = AHIO
